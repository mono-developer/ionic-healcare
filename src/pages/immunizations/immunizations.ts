...
export class ImmunizationsPage {
           ...
           .subscribe(
             (data) => {
               ...
               if(data.success == false){
                 ...
                 console.log("Immunizations  Data", data);
                 this.immunizationsData = data.immunizations;
               }
           });
       });
     });
  ...
  editImmunizationsData(event, id){
    this.navCtrl.push('ImmunizationsEditPage',{ edit:'edit', id: id, profile_id: this.profile_id});
  }
