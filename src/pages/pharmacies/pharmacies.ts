...
export class PharmaciesPage {
           ...
           .subscribe(
             (data) => {
               ...
               if(data.success == false){
                 ...
                 this.pharmaciesData = data.pharmacies;
               }
           });
       });
     });
  ...
  createPharmaciesData(){
    ...
    let profileModal = this.modalCtrl.create('PharmaciesEditPage', { save: 'save', profile_id:this.profile_id });
  ...
  editPharmaciesData($event, id){
    console.log('go PharmaciesEditPage');
    this.navCtrl.push('PharmaciesEditPage', { edit:'edit', id: id, profile_id:this.profile_id });
  }
